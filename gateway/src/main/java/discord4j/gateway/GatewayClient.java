...
/**
 * Represents a Discord WebSocket client, or Gateway.
 * <p>
 * Allows downstream consumers to receive inbound events through {@link #dispatch()} and direct raw payloads through
 * {@link #receiver()} and allows a user to submit events through {@link #sender()} or
 * {@link #send(org.reactivestreams.Publisher)}.
 */
